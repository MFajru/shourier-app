...
const generateAddressDetailId = (userId, dataLength)=>{
    const strNumber = (parseInt(userId) * 100 + dataLength).toString();
    return strNumber;
};
...
"[project]/src/pages/user/address/newAddress.tsx [ssr] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_require_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, l: __turbopack_load__, j: __turbopack_dynamic__, p: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$generator$2f$generateAddressDetailId$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/utils/generator/generateAddressDetailId.ts [ssr] (ecmascript)");
"__TURBOPACK__ecmascript__hoisting__location__";
;
;
;
    ...
    const patchDestinationAddress = async (newArrAddress)=>{
        try {
            if (userId) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["toast"].success("Add successfull");
                return response.data;
            }
        } catch (error) {
    ...
    const handleSubmitAddress = async (e)=>{
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$formValidation$2f$isValidForm$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isValidForm"](destAddressForm, setIsFormError)) {
            ...
            if (existingAddress.data && userId) {
                ...
                newAddress.push({
                    ...destAddressForm,
                    id: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$generator$2f$generateAddressDetailId$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["generateAddressDetailId"](userId, existingAddress.data.address.length)
                });
...
//# sourceMappingURL=[root of the server]__8da96f._.js.map