...
const EditPromo = ()=>{
    ...
    const patchPromo = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["toast"].error("Somehting wrong happened, failed to save");
            console.error(error);
        }
    };
    ...
    const handleOnSubmit = async (e)=>{
        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$formValidation$2f$isValidForm$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isValidForm"](promoData, setIsFormError)) {
            await patchPromo();
        }
    };
...
//# sourceMappingURL=[root of the server]__26e372._.js.map