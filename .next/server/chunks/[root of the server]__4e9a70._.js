...
"[project]/src/pages/admin/address/[addressId]/editAddress.tsx [ssr] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_require_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, l: __turbopack_load__, j: __turbopack_dynamic__, p: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
const EditAddress = ()=>{
    const router = __TURBOPACK__external__next$2f$router__["useRouter"]();
    const [originAddressData, setOriginAddressData] = __TURBOPACK__external__react__["useState"]({
        addressName: "",
        city: "",
        cityId: "",
        province: "",
    ...
    const city = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCustomSWR$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["useCustomSWR"](originAddressData.provinceId != "" ? `/api/getCity?province=${originAddressData.provinceId}` : null);
    const existingOriginAddress = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCustomSWR$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["useCustomSWR"](router.query.addressId ? `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$index$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["apiBaseUrl"]}/originAddress/${router.query.addressId}` : null);
    const patchOriginAddress = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].patch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$index$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["apiBaseUrl"]}/originAddress/${router.query.addressId}`, {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["toast"].success("Update successfull");
            return response.data;
        } catch (error) {
    ...
    const onSubmitForm = async (e)=>{
        e.preventDefault();
        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$formValidation$2f$isValidForm$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isValidForm"](originAddressData, setIsFormError)) {
    ...
    return /*#__PURE__*/ __TURBOPACK__external__react$2f$jsx$2d$dev$2d$runtime__["jsxDEV"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Layout$2f$AdminLayout$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__["default"], {
        children: [
            ...
            originAddressData && originAddressData.city != "" && originAddressData.province != "" && provinceOptions.length != 0 && cityOptions.length != 0 ? /*#__PURE__*/ __TURBOPACK__external__react$2f$jsx$2d$dev$2d$runtime__["jsxDEV"]("form", {
                className: "mt-5",
...
//# sourceMappingURL=[root of the server]__4e9a70._.js.map