(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__f2cff5._.js", {
...
const EarningReports = ()=>{
    ...
    const [earningsPerMonth, setEarningPerMonth] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"]({
        january: 0,
        february: 0,
        march: 0,
        april: 0,
        ...
        if (shipping.data) {
            ...
            for (const ship of shipping.data){
                for (const detail of ship.shippingDetails){
                    ...
                    tempEarning[month] += detail.costAfter;
                }
            }
            setEarningPerMonth(tempEarning);
        }
    }, [
        shipping.data
    ]);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        if (earningsPerMonth) {
            const tempIncome = [];
            for(const key in earningsPerMonth){
                tempIncome.push(earningsPerMonth[key]);
            }
            setNetIncomeData(tempIncome);
        }
    }, [
        earningsPerMonth
    ]);
        ...
        children: [
            ...
            /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"]("div", {
                ...
                children: /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Chart$2f$LineChart$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                    myDatasets: [
                        {
                            label: "Net Income Datasets Per Month",
                            data: netIncomeData,
                            borderColor: "blue",
...
_s(EarningReports, "DTJsQyequ2Umb+u1cxU70tr+tA4=", false, function() {
    return [
...
//# sourceMappingURL=[root of the server]__f2cff5._.js.map