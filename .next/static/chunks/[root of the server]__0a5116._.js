(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__0a5116._.js", {
...
const SignUp = ()=>{
    ...
    const fetchRegister = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$index$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["apiBaseUrl"]}`);
        } catch (error) {
            console.error(error);
        }
    };
...
//# sourceMappingURL=[root of the server]__0a5116._.js.map