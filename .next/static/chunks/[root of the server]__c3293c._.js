(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__c3293c._.js", {
...
const EditAddress = ()=>{
    ...
    const city = useSWR(originAddressData.provinceId != "" ? `/api/getCity?province=${originAddressData.provinceId}` : null, fetcher, {
...
_s(EditAddress, "byjqy2jHHVpsc0mk+Dqz5gjWG+4=", true, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=[root of the server]__c3293c._.js.map