(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__44d21d._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$formValidation$2f$isNumber$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/utils/formValidation/isNumber.ts [client] (ecmascript)");
"__TURBOPACK__ecmascript__hoisting__location__";
;
var _s = __turbopack_refresh__.signature();
;
...
const UserProfile = ()=>{
    ...
    const [isDataChange, setIsDataChange] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"](false);
    ...
    const handleOnChange = async (e)=>{
        ...
        if (e.target.name === "phoneNumber" && value.length <= 12) {
            value = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$formValidation$2f$isNumber$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["regexToNumber"](value);
        } else {
            return;
        }
...
_s(UserProfile, "txApoapOfM5dWGd5WG4C2HEJoXU=", false, function() {
    return [
...
//# sourceMappingURL=[root of the server]__44d21d._.js.map