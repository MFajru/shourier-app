(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__b39e7a._.js", {
...
const AddAddress = ()=>{
    ...
    const city = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCustomSWR$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["useCustomSWR"](`/api/getCity?province=${originAddressData.provinceId}`);
    ...
    // const handleOnChangeProvince = (e: React.ChangeEvent<HTMLSelectElement>) => {
    //   if (province.data) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        if (originAddressData.provinceId) {
            city.mutate();
        }
    }, [
        originAddressData.provinceId,
        city
    ]);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        if (province.data) {
...
_s(AddAddress, "nfFmzBTjW0XMycgf4ATxkRbJWo8=", false, function() {
    return [
...
//# sourceMappingURL=[root of the server]__b39e7a._.js.map